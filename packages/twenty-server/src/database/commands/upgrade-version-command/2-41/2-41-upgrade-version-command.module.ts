...
import { NormalizeWorkflowRecordCrudRichTextFieldsCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-workspace-command-1789390440000-normalize-workflow-record-crud-rich-text-fields.command';
